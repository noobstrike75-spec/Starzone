      ...
      <main style={{ maxWidth: 700, margin: "0 auto", padding: "1rem" }}>
        ...
        {table.length === 0 && !error && (
          <div style={{ background: "#fff", padding: "1rem", borderRadius: "10px" }}>
            <p style={{ color: "#c0392b", fontWeight: 600 }}>No standings data returned.</p>
            <p style={{ fontSize: "0.75rem", color: "#666" }}>Requested league={league}, season={season}</p>
            <pre style={{ fontSize: "0.65rem", overflowX: "auto", background: "#f4f4f4", padding: "0.5rem", borderRadius: "6px" }}>
